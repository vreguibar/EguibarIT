...
Describe "$ModuleName Module - HELP" -Tags "Module" {
    #$Commands = (get-command -Module EguibarIT).Name
    ...
    FOREACH ($c in $ExportedFunctions)
    {
        ...
        Context "$c - Help"{
                ...
                It "Notes - Version" {$Notes[0].trim()| Should not BeNullOrEmpty} # Version
                #It "Notes - DateModified" {$Notes[1].trim()| Should not BeNullOrEmpty} #
                #It "Notes - LasModifiedBy" {$Notes[2].trim()| Should not BeNullOrEmpty} #
                #It "Notes - LasModifiedBy" {$Notes[2].trim()| Should not BeNullOrEmpty} #
