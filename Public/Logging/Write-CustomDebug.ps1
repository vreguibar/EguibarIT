function Write-CustomDebug {
    ...
    <#
        .SYNOPSIS
            Mimics Write-Debug but with optional logging to the Windows Event Log.

        .DESCRIPTION
            This function writes debug messages to the console and, if instructed, to the specified Windows Event Log.
        ...
        .EXAMPLE
            ...
            Write-CustomDebug -Message "Starting process" -Verbose

        .EXAMPLE
            # Log a error message and also create a Windows Event Log entry with predefined event info
            Write-CustomDebug -CreateWindowsEvent -EventInfo ([EventIDs]::AuthenticationFailed) -Message "Unknown user."
        ...
        .EXAMPLE
            ...
            Write-CustomDebug @Splat

        .EXAMPLE
            # Log a custom event with specific event details
            Write-CustomDebug -CreateWindowsEvent -EventId 20001 -EventName "Authentication Failure" -EventCategory Security
