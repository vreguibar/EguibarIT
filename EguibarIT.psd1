...
@{
    ...
    'ConvertTo-IPv4Integer', 'CnvertTo-IP4MaskBit',
    'ConvertTo-IPv4MaskString', 'ConvertT-IPv4NetwokAddress',
    'ConvertTo-WmiFilter', 'Get-AdSite', 'Get-AllASiteLink',
    'Get-AllAdSubnet', 'Grant-NTFSPermissio', 'ImportMyModule',
    'New-AdDelegatedGroup', 'New-AGPMobject', 'New-AreahareNTFS',
    'New-CaObject', 'New-CentralItOU', 'New-DeleateAdGpo',
    'New-DelegateAdOU', 'New-DelegateSitOU', 'New-fsObject',
    'New-DhcpObject', 'New-EitAdSite', 'New-ExchageObject',
    'New-LapsObject', 'New-LocalLogonTask', 'New-TimeolicyGPO',
    'New-WsusObjects', 'Revoke-Inheritance', 'Reoke-NTFSPemissions',
    'Set-AdAclDelegateComputerAdmin', 'Set-AAclDelegatGalAdmin',
    'Set-AdAclDelegateUserAdin', 'Set-dAclLaps',
    'Start-AdAclDelegateComputerAdmi', 'Start-dCleanOU',
    ...
    PrivateData          = @{
        ...
        PSData = @{
            ...
            'DelegationModel', 'TierModel', 'RBACmodel', 'RoleBasedAccessControl_model', 'DelegationModel',
            'TierModel', 'RBACmodel', 'Infrastructure', 'Testing', 'Checks', 'Audits', 'Checklist',
            'Validation', 'CredentialTheaf', 'Pass-the-Hash', 'Pass-the-Ticket', 'Golden_Ticket', 'Silver_Ticket'
