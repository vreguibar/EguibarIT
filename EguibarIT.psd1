...
@{
    ...
    'Import-MyModule', 'Install-SqlServer', 'Install-WindowsADK',
    'New-AclSddl', 'New-AdDelegatedGroup', 'New-AGPMobject',
    'New-AreaShareNTFS', 'New-CaObject', 'New-CentralItOU',
    'New-DelegateAdGpo', 'New-DelegateAdOU', 'New-DelegateSiteOU',
    'New-DfsObject', 'New-DhcpObject', 'New-EitAdSite',
    'New-ExchangeObject', 'New-LapsObject', 'New-LocalLogonTask',
    'New-Tier0AdminAccount', 'New-Tier0AdminGroup',
    ...
    'Set-SqlServerFirewall', 'Start-AdCleanOU', 'Start-AdDelegatedSite',
    'Test-IPv4MaskString', 'Test-KdsRootKeyPrerequisite',
    'Test-RegistryValue', 'Uninstall-SqlServer'
