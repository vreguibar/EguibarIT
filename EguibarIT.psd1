...
FunctionsToExport = 'Write-CustomDebug', 'Write-CustomError', 'Write-CustomLog', 
               'Write-CustomVerbose', 'Write-CustomWarning', 'Add-AdGroupNesting', 
               'ConvertTo-IntegerIPv4', 'ConvertTo-IPv4Integer', 
               'ConvertTo-IPv4MaskBit', 'ConvertTo-IPv4MaskString', 
               'ConvertTo-IPv4NetworkAddress', 'ConvertTo-WmiFilter', 
               'Enable-KerberosClaimSupport', 'Get-AdSite', 'Get-ADUserPermission', 
               'Get-AllAdSiteLink', 'Get-AllAdSubnet', 'Grant-NTFSPermission', 
               'Import-MyModule', 'New-AclSddl', 'New-AdDelegatedGroup', 
               'New-AGPMobject', 'New-AreaShareNTFS', 'New-CaObject', 
               'New-CentralItOU', 'New-DelegateAdGpo', 'New-DelegateAdOU', 
               'New-DelegateSiteOU', 'New-DfsObject', 'New-DhcpObject', 
               'New-EitAdSite', 'New-ExchangeObject', 'New-LapsObject', 
               'New-LocalLogonTask', 'New-Tier0AdminAccount', 'New-Tier0AdminGroup', 
               'New-Tier0AuthPolicyAndSilo', 'New-Tier0CreateOU', 
               'New-Tier0Delegation', 'New-Tier0FineGrainPasswordPolicy', 
               'New-Tier0gMSA', 'New-Tier0Gpo', 'New-Tier0GpoRestriction', 
               'New-Tier0MoveObject', 'New-Tier0NestingGroup', 
               'New-Tier0Redirection', 'New-Tier1', 'New-Tier2', 'New-TimePolicyGPO', 
               'New-WsusObjects', 'Revoke-Inheritance', 'Revoke-NTFSPermissions', 
               'Set-AdAclDelegateComputerAdmin', 'Set-AdAclDelegateGalAdmin', 
               'Set-AdAclDelegateUserAdmin', 'Set-AdAclLaps', 'Start-AdCleanOU', 
               'Start-AdDelegatedSite', 'Test-IPv4MaskString', 
               'Test-KdsRootKeyPrerequisite', 'Test-RegistryValue'
