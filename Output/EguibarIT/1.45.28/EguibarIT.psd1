...
FunctionsToExport = 'ConvertTo-IPv4MaskBit', 'ConvertTo-IPv4MaskString', 
               'ConvertTo-WmiFilter', 'Get-AdSite', 'Get-AllAdSiteLink', 
               'Get-AllAdSubnet', 'Get-OsBuild', 'Grant-NTFSPermissions', 
               'Import-MyModule', 'New-AGPMobjects', 'New-AreaShareNTFS', 
               'New-CaObjects', 'New-CentralItOU', 'New-DelegateAdGpo', 
               'New-DelegatedAdOU', 'New-DelegateSiteOU', 'New-DfsObjects', 
               'New-DhcpObjects', 'New-EitAdSite', 'New-ExchangeObjects', 
               'New-LapsObjects', 'New-LocalLogonTask', 'New-TimePolicyGPO', 
